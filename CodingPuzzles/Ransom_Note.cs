...
namespace CodingPuzzles
{
    ...
    {
        public static bool RansomNoteChars(string note, string mag)
        {
        ...
        public static bool RansomNoteWords(string note, string mag)
        {
        ...
        //string note = "aabb";
        //string mag = "aaabb";
        //Console.WriteLine(Ransom_Note.RansomNoteChars(note, mag));

        ////Call in Program.cs to test
        ////Output should be true
        //bool a = Ransom_Note.RansomNoteWords("  they   to  ", "        two    systems are talking to each other, they always need to specify what encoding      ");
        //Console.WriteLine(a);
    }
}